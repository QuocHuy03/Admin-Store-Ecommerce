...
export default function Edit() {
  ...
  const { data, isLoading } = useQuery(
    ["edit-category", isSlug],
    () => fetchCategoryBySlug(isSlug),
    {
      staleTime: 500,
  ...
  const updateCategoryMutation = useMutation((data) =>
    fetchUpdateCategory(isSlug, data)
  );
  ...
  return (
    <Layout>
      <div className="flex items-center justify-between px-6">
        <Link to="/categories" className=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
          List Category
        </Link>
      </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <select
                    ...
                    defaultValue={data?.statusCategory}
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    defaultValue={data.outstandingCategory}
